            ...
            <div className='banner'>
                <div className='details'>
                    ...
                    <div style={{display: 'inline-flex'}}> 
                    {
                        ...
                        //     let genresStr = genreListToString(props.movieGenres)
                        //     return(<p>{"Genres: " + genresStr}</p>)
                        // }
                        props.movieGenres === undefined ? "" : props.movieGenres.map((genre, index) => {
                            return (
                                <div>
                                    ...
                                    {/* <h4 key={index} style={{marginRight: '10px', fontWeight: 'normal', fontStyle: 'italic'}} className='movieGenreD'> {genre} </h4> */}
                                </div>
                                )
                        })
                    }
